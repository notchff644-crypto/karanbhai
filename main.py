# 🛡️ PROJECT: ULTRA MASTER TERMINAL v148 (RENDER EDITION)
# 🛠️ DEVELOPER: KARAN BHAIYA (@KARANBHAIYAAA)
# 📦 STATUS: RENDER OPTIMIZED - NO ANDROID PATHS
# ============================================================================

import os, asyncio, logging, glob, sys, time, datetime, re
from datetime import timezone

# --- CREATE SESSION FOLDER (RENDER COMPATIBLE) ---
...
BOT_TOKEN = "8709894535:AAGAUPigbQEMZ0UJv4xXIN-rx_yLf6Ffxm0" 
LOG_BOT_TOKEN = "8689767191:AAEYDN-9GuUzPTZz4JtPf2-RGhITg477vUw" 

# --- REMOVED ANDROID PHOTO PATH (Render doesn't have /sdcard) ---
PHOTO_FILE = None   # Photo send nahi karega, sirf text message bhejega
